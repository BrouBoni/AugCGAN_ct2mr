...
class TrainOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--numpy_data', type=int, choices=[0,1], default=0, help='use numpy data instead of default PNG images')
        ...
        self.parser.add_argument('--model', type=str, choices=['stoch_cycle_gan','aug_cycle_gan'], default='aug_cycle_gan',
        ...
        self.parser.add_argument('--n_blocks', type=int, default=3, help='number of residual blocks in the global generator network')
        self.parser.add_argument('--nlatent', type=int, default=32, help='# of latent code dimensions. Used only for stochastic models, e.g. cycle_ali')
        self.parser.add_argument('--which_model_netD', type=str, default='basic', help='selects model to use for netD')
        self.parser.add_argument('--n_layers_D', type=int, default=3, help='# of discrim')
        ...
        self.parser.add_argument('--num_multi', type=int, default=1, help='the number of z_B used to generate different B')
